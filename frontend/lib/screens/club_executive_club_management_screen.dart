...
class ClubExecutiveClubManagementScreen extends StatefulWidget {
  final String? token;
  final int? clubId;
  
  const ClubExecutiveClubManagementScreen({
    Key? key,
    this.token,
    this.clubId,
  }) : super(key: key);
  ...
  @override
  _ClubExecutiveClubManagementScreenState createState() => _ClubExecutiveClubManagementScreenState();
}

class _ClubExecutiveClubManagementScreenState extends State<ClubExecutiveClubManagementScreen> {
